...
@section('title')
    <title>Update Profile Dosen Pembimbing | SiMagang</title>
@endsection
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title">Ubah Profile Dosen Pembimbing</h4>
                </div>
                <!--end page-title-box-->
            </div>
            <!--end col-->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('profile.dospem.update', Auth()->user()->id) }}" method="POST">
                            @method('put')
                            @csrf
