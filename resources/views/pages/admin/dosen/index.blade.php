...
@section('title')
    <title>Manajemen Dosen | SiMagang</title>
@endsection
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title">Manajemen Dosen</h4>
                </div>
                <!--end page-title-box-->
            </div>
            <!--end col-->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <a href="{{ route('admin.dosen.create') }}" class="btn btn-primary px-4 mt-0 mb-3"
                                ...
                                <tbody>
                                    @foreach ($dosens as $item)
                                        <tr class="text-center">
                                            ...
                                            <td class="text-left">{{ $item->nidn }}</td>
                                            <td class="text-left">{{ $item->email }}</td>
                                            <td class="text-left">{{ $item->prodi->nama_program_studi }}</td>
                                            <td>
                                                <a href="{{ route('admin.dosen.edit', $item->id) }}" class="mr-2"
                                                    data-animation="bounce">
                                                    <i class="fas fa-edit text-info font-16"></i>
                                                </a>
                                                <a href="{{ route('admin.dosen.destroy', $item->id) }}">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title mt-0" id="myLargeModalLabel">Import Data Dosen</h5>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="form-label" for="file">File Excel Dosen <span
