                ...
                <div class="card">
                    <div class="card-body">
                        <a href="{{ route('koordinator.pelamar.magang.diterima.index') }}"
                            ...
                            <i class="fa-solid fa-circle-check"></i>&ensp;Lamaran Diterima
                        </a>&ensp;
                                ...
                                <tbody>
                                    @foreach ($pelamar_magang_menunggu as $item)
                                        <tr class="text-center">
                                            ...
                                            <td>
                                                <a href="{{ route('koordinator.pelamar.magang.diterima', $item->id) }}"
                                                    title="Diterima">
                                                    <i class="fa-solid fa-circle-check text-success font-16"></i>
                                                </a>
                                                &ensp;
                                                <a href="{{ route('koordinator.pelamar.magang.ditolak', $item->id) }}"
                                                    title="Ditolak">
