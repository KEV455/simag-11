...
@section('title')
    <title>Tambah Mitra | SiMagang</title>
@endsection
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title">Tambah Mitra Baru</h4>
                </div>
                <!--end page-title-box-->
            </div>
            <!--end col-->
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('koordinator.mitra.store') }}" enctype="multipart/form-data" method="POST">
                            @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="form-label" for="foto">Foto <span class="text-primary">*(Opsional,
                                        ...
                                        <div class="custom-file mb-3">
                                            ...
                                            <label class="custom-file-label" for="foto" id="fileLabel">
                                                ...
                                                {{ session('foto') ? session('foto') : 'Choose file' }}
                                            </label>
                                            @error('foto')
