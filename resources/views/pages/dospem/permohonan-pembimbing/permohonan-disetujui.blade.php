...
@section('title')
    <title>Permohonan Dosen Pembimbing Mahasiswa Disetujui | SiMagang</title>
@endsection
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    <h4 class="page-title">Permohonan Dosen Pembimbing Mahasiswa Disetujui ||
                        {{ $dospem->dosen->nama_dosen }}</h4>
                </div>
                <!--end page-title-box-->
            </div>
            <!--end col-->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{route('dospem.validasi.permohonan.ditolak.index')}}" class="btn btn-danger px-4 mt-0 mb-3" data-animation="bounce">
